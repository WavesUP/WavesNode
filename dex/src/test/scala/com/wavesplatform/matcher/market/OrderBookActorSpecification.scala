  ...
  "OrderBookActor" should {
    ...
    "rules are switched" in obcTestWithMatchingRules(switchRulesTest) { (pair, orderBook, tp) =>
      ...
      eventually {
        ...
        val l41 = bids.head
        l41.price shouldBe buyOrder.price
        l41.amount shouldBe buyOrder.amount * 4

        val l40 = bids(1)
        l40.price shouldBe (0.000004 * Order.PriceConstant)
        l40.amount shouldBe buyOrder.amount * 6

        val l30 = bids(2)
        l30.price shouldBe (0.000003 * Order.PriceConstant)
        l30.amount shouldBe buyOrder.amount * 8
      }
    }
    ...
    "rules can be disabled" in obcTestWithMatchingRules(disableRulesTest) { (pair, orderBook, tp) =>
      ...
      eventually {
        ...
        val l41 = bids.head
        l41.price shouldBe buyOrder.price
        l41.amount shouldBe buyOrder.amount * 8

        val l40 = bids(1)
        l40.price shouldBe (0.000004 * Order.PriceConstant)
        l40.amount shouldBe buyOrder.amount * 3
      }
    }
  }
}
