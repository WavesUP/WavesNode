...
import com.wavesplatform.leveldb.LevelDBException;
...
public class NativeLevelDB {
    ...
    public static native void leveldb_compact_range(LevelDB levelDB,
                                                    byte[] start_key, size_t start_key_len,
                                                    byte[] limit_key, size_t limit_key_len);
    ...
    public static native void leveldb_options_set_comparator(Options options, NativeLevelDB.Comparator comparator);

    public static native void leveldb_options_set_filter_policy(Options options, NativeLevelDB.FilterPolicy filterPolicy);
    ...
    public static native void leveldb_options_set_env(Options options, NativeLevelDB.Env env);

    public static native void leveldb_options_set_info_log(Options options, NativeLevelDB.Logger logger);

    public static native void leveldb_options_set_write_buffer_size(Options options, size_t writeBufferSize);

    public static native void leveldb_options_set_max_open_files(Options options, int maxOpenFiles);

    public static native void leveldb_options_set_cache(Options options, NativeLevelDB.Cache cache);

    public static native void leveldb_options_set_block_size(Options options, size_t blockSize);

    public static native void leveldb_options_set_max_file_size(Options options, size_t fileSize);
    ...
    public static native Cache leveldb_cache_create_lru(size_t capacity);
    ...
    public static native Iterator leveldb_create_iterator(NativeLevelDB.LevelDB levelDB, ReadOptions options);
    ...
    public static native void leveldb_iter_seek(Iterator iterator, byte[] k, size_t klen);
    ...
    public static native Snapshot leveldb_create_snapshot(NativeLevelDB.LevelDB levelDB);

    public static native void leveldb_release_snapshot(NativeLevelDB.LevelDB levelDB, Snapshot snapshot);
